...
import ManagerLayout from "../dashboard/Manager/Layout";
import RecruiterLayout from "../dashboard/Recruiter/Layout";
import ClientLayout from "../dashboard/client/Layout";
import InterviewerLayout from "../dashboard/Interviewer/Layout";
import { Breadcrumb, message, Button } from "antd";
import Pageloading from "./loading/Pageloading";

const JobInterviewCalendar = () => {
...
export default JobInterviewCalendar;
