...
const Candidate = () => {
    ...
    return (
        <Main defaultSelectedKey="1">
            <div className="flex flex-col lg:flex-row gap-5 w-full justify-between items-stretch">
                ...
                <div className="flex flex-col items-center justify-evenly gap-2.5 p-2.5 border border-[#bec3c8] rounded-lg bg-white flex-1">
